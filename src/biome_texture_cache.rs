...
impl BiomeTextureCache {
    ...
    >(
        ...
        let texture_data =
            crate::texture_gen::generate_biome_texture_data(128, 128, biome_params, block_type_str);
    ...
    fn add_to_cache(
        ...
        self.stats.peak_memory_used_bytes = self
            .stats
            .peak_memory_used_bytes
            .max(self.stats.memory_used_bytes);
    ...
    pub fn print_stats(&self) {
        ...
        println!(
            "  Peak Memory: {:.2} MB",
            self.stats.peak_memory_used_bytes as f64 / 1024.0 / 1024.0
        );
    }
