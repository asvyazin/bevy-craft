...
pub fn initialize_item_texture_atlas(
    ...
    texture_handles.insert(ItemType::Block(BlockType::Grass), asset_server.load("textures/grass_icon.png"));
    texture_handles.insert(ItemType::Block(BlockType::Dirt), asset_server.load("textures/dirt_icon.png"));
    texture_handles.insert(ItemType::Block(BlockType::Stone), asset_server.load("textures/stone_icon.png"));
    texture_handles.insert(ItemType::Block(BlockType::Wood), asset_server.load("textures/wood_icon.png"));
    texture_handles.insert(ItemType::Block(BlockType::Leaves), asset_server.load("textures/leaves_icon.png"));
    texture_handles.insert(ItemType::Block(BlockType::Sand), asset_server.load("textures/sand_icon.png"));
    texture_handles.insert(ItemType::Block(BlockType::Bedrock), asset_server.load("textures/bedrock_icon.png"));
    texture_handles.insert(ItemType::Block(BlockType::Water), asset_server.load("textures/water_icon.png"));
    
    // Load textures for tools
    texture_handles.insert(ItemType::Tool(crate::inventory::ToolType::Pickaxe), asset_server.load("textures/pickaxe_icon.png"));
    texture_handles.insert(ItemType::Tool(crate::inventory::ToolType::Axe), asset_server.load("textures/axe_icon.png"));
    texture_handles.insert(ItemType::Tool(crate::inventory::ToolType::Shovel), asset_server.load("textures/shovel_icon.png"));
    texture_handles.insert(ItemType::Tool(crate::inventory::ToolType::Sword), asset_server.load("textures/sword_icon.png"));
    
    // Load textures for resources
    texture_handles.insert(ItemType::Resource(crate::inventory::ResourceType::Stick), asset_server.load("textures/stick_icon.png"));
    texture_handles.insert(ItemType::Resource(crate::inventory::ResourceType::String), asset_server.load("textures/string_icon.png"));
    texture_handles.insert(ItemType::Resource(crate::inventory::ResourceType::Coal), asset_server.load("textures/coal_icon.png"));
    texture_handles.insert(ItemType::Resource(crate::inventory::ResourceType::IronIngot), asset_server.load("textures/iron_ingot_icon.png"));
    texture_handles.insert(ItemType::Resource(crate::inventory::ResourceType::GoldIngot), asset_server.load("textures/gold_ingot_icon.png"));
