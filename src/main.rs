...
fn main() {
    App::new()
        ...
        .add_systems(Startup, initialize_block_textures.after(initialize_texture_atlas))
        ...
        .add_systems(Startup, alkyd_integration::generate_all_block_textures) // Generate enhanced textures
