...
impl TextureAtlas {
    ...
    pub fn initialize(
        ...
        grass_uvs.insert(
            BlockFace::Side,
            (0.0, CELL_HEIGHT, CELL_WIDTH, CELL_HEIGHT * 2.0),
        );
        grass_uvs.insert(
            BlockFace::Bottom,
            (0.0, CELL_HEIGHT, CELL_WIDTH, CELL_HEIGHT * 2.0),
        ...
        dirt_uvs.insert(
            BlockFace::Top,
            (CELL_WIDTH, 0.0, CELL_WIDTH * 2.0, CELL_HEIGHT),
        );
        dirt_uvs.insert(
            BlockFace::Side,
            (CELL_WIDTH, CELL_HEIGHT, CELL_WIDTH * 2.0, CELL_HEIGHT * 2.0),
        );
        dirt_uvs.insert(
            BlockFace::Bottom,
            (CELL_WIDTH, CELL_HEIGHT, CELL_WIDTH * 2.0, CELL_HEIGHT * 2.0),
        ...
        wood_uvs.insert(
            BlockFace::Top,
            (CELL_WIDTH * 3.0, 0.0, CELL_WIDTH * 4.0, CELL_HEIGHT),
        );
        wood_uvs.insert(
            BlockFace::Bottom,
            (CELL_WIDTH * 3.0, 0.0, CELL_WIDTH * 4.0, CELL_HEIGHT),
    ...
    pub fn load_procedural_textures(&mut self, block_textures: &Res<BlockTextures>) {
        ...
        println!(
            "  Debug: BlockTextures textures count: {}",
            block_textures.textures.len()
        );
        ...
        for (name, block_type) in block_type_mapping {
            if let Some(texture_handle) = block_textures.textures.get(name) {
                self.procedural_textures
                    .insert(block_type, texture_handle.clone());
